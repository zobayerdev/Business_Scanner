...
public class FreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Free QR Generator");
        ...
        generate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (link.getText().toString().trim().length()  == 0) {
                    Toast.makeText(FreeActivity.this, "Make sure your given Text..!", Toast.LENGTH_SHORT).show();
                } else {
                    try {
                        ...
                        download.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                MediaStore.Images.Media.insertImage(getContentResolver(), bitmap, "Shop_Identity"
                                        , null);
                                Toast.makeText(FreeActivity.this, "Download Complete", Toast.LENGTH_SHORT).show();
                            }
                        });
